...
$UniqueName  = "International Transfer";
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-4">
                                    <select class="form-control  basic" required name="account_type">
                                ...
                                <div class="input-group mb-4">
                                    <select class="form-control  basic" required name="bank_country">
                                ...
                                <div class="input-group">
                                    <button class="btn btn-primary mb-2" name="wire-transfer" style="background-color: #9d7a3e !important; border-color: none !important;box-shadow: none !important;border-color: #617a87;">Make Transfer</button>
                                </div>
