...
$UniqueName  = "Edit Wire Transactions";
...
if (isset($_POST['accept'])) {
    ...
    $sql = "UPDATE transactions SET trans_status=:wire_status WHERE refrence_id=:id";
    ...
    $message = $sendMail->AdminWireMsg($full_name, $amount, $user_balance, $trans_status, $trans_type, $APP_NAME, $APP_URL, $SITE_ADDRESS);
...
if (isset($_POST['hold'])) {
    ...
    if (true) {
        ...
        <center>	<strong style='color:black;'>Transaction hold successfully, Please Wait while we redirect you...
               </strong></center>
          </div>
        ";
    } else {
...
if (isset($_POST['update_trans'])) {
    ...
    $sql = "UPDATE transactions SET amount=:amount,bank_name=:bank_name,account_name=:account_name,account_number=:account_number,account_type=:account_type,bank_country=:bank_country,routine_number=:routine_number,created_at=:created_at WHERE refrence_id=:id";
    $stmt = $conn->prepare($sql);
    $stmt->execute([
        'amount' => $amount,
        'bank_name' => $bank_name,
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" inputmode="numeric" required pattern="[0-9]+" maxlength="12" autocomplete="off" class="form-control" value="<?= $result['routine_number'] ?>" name="routine_number" placeholder="9876567656">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="account_type" required class="form-control" data-width='100%'>
                                    <option value="<?= $result['account_type'] ?>">Select Account Type</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="bank_country" required class="form-control" data-width='100%'>
                                    <option value="<?= $result['bank_country'] ?>">Select Country</option>
