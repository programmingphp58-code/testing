...
$sql = "SELECT * FROM temp_dumps WHERE internetid =:internetid AND trans_type ='Domestic transfer' ORDER BY trans_id DESC LIMIT 1";
            ...
            if (true) {
                ...
                if (true) {
                    ...
                    if ($page['padiwise_sms'] == '1') {
                        $messageText = "New Domestic Transfer";
                        ...
                        <?php if (isset($msg1)) echo $msg1; ?>
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group">
                                    <button class="btn btn-primary mb-2" type="submit" name="dom_submit">Verify Pincode</button>
                                </div>
