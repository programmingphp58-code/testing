                        ...
                        <div class="widget-content widget-content-area">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group">
                                    <button class="btn btn-primary mb-2" style="background-color: #9d7a3e !important; border-color: none !important;box-shadow: none !important;border-color: #617a87;" name="domestic-transfer">Make Transfer</button>
                                </div>
