                    ...
                    <div class="row clearfix">
                        ...
                        <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                            <div class="footer-widget logo-widget">
                                ...
                                <div class="call">
                                    Call us directly
                                    <a class="phone" href="#">+<?= $page['website_tel'] ?></a>
                                    <a class="email" href="mailto:<?= $page['website_email'] ?>"><?= $page['website_email'] ?></a>
                                </div>
                        ...
                        <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                            <div class="footer-widget links-widget">
                                <h5>Company</h5>
                                <ul class="list-link">
                                    <li><a href="<?= $web_url?>/p/about">About Us</a></li>
                                    <li><a href="<?= $web_url?>/p/working-capital-loans">Working Loans</a></li>
                                    <li><a href="<?= $web_url?>/p/ultimate-checking">Ultimate Checking</a></li>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                            <div class="footer-widget links-widget">
                                <h5>Quick Links</h5>
                                <ul class="list-link">
                                    <li><a href="<?= $web_url?>/p/business-savings-account">Business Account</a></li>
                                    <li><a href="<?= $web_url?>/p/lost-cards">Lost Card</a></li>
                                    <li><a href="<?= $web_url?>/p/health-savings-account">Health Savings</a></li>
