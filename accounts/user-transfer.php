...
require($_SERVER['DOCUMENT_ROOT'] . "/configuration/Transfer/UserTransfer.php");
?>
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <label for="basic-url">Paynment Account</label>
                                <div class="input-group mb-4">
                                ...
                                <div class="input-group">
                                    <button class="btn btn-primary mb-2" name="user_submit" style="background-color: #9d7a3e !important; border-color: none !important;box-shadow: none !important;border-color: #617a87;">Make Transfer</button>
                                </div>
