            ...
            <div class="row align-items-center clearfix">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12 mb-0">
                    <div class="inner-column">
                        ...
                        <div class="text">
                            <p>
                                <?= $UniqueName ?>® is a federally chartered savings bank headquartered in United States.

                                As a recognized leader in the industry, National Trust Bank has been named among the top community banks and thrifts and the top-performing mid-sized banks in the nation. Though we’re receiving attention across the United States for what we do, our focus is and always has been on our customers.
                            </p>
                            <p>
            ...
            <div class="form-column col-lg-5 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="form-boxed">
                        <!-- <h5>Our Values</h5> -->
                        <div class="text">The mission of <?= $UniqueName ?> is to contribute to the sustainable development of the international banking sector by
