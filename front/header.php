...
require_once(dirname($_SERVER['SCRIPT_FILENAME']) . "/configuration/Function/Function.php");
// require_once("configuration/Function.php");
//require __DIR__."/../configuration/loginFunction.php";
// require_once __DIR__."/../session.php";
// require_once("/configuration/UserFunction.php");
...
<head>
    ...
    <meta property="og:image" content="<?= $web_url?>/assets/images/logo/<?= $page['image'] ?>" />
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header style-three">
                    ...
                    <div class="inner-container clearfix">
                        ...
                        <div class="top-left">
                            ...
                            <ul class="info-list">
                                ...
                                <li class="share"><a href="<?= $web_url?>/p/about"><span class="icon icofont-handshake-deal"></span> Why Trust <?= $UniqueName  ?></a></li>
                ...
                <div class="auto-container">
                    <div class="inner-container clearfix">
                        <div class="pull-left logo-box">
                            <div class="logo">
                                <a href="<?= $web_url?>"><img src="<?= $web_url?>/assets/images/logo/<?= $page['image'] ?>" alt="" title="" width="200px" height="90px" /></a>
                            </div>
                        </div>
                        ...
                        <div class="outer-box">
                            ...
                            <div class="search-box-btn search-box-outer">
                                <a href="<?= $web_url?>/login.php" class="theme-btn btn-style-one" style="margin-top:0px;padding:10px 20px;"><span class="txt">LOGIN</span></a>
                            </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo">
                        <a href="<?= $web_url?>"><img src="<?= $web_url?>/assets/images/logo/<?= $page['image'] ?>" alt="" title="" width="90px" /></a>
                    </div>
