    ...
    <div class="contact-info-boxed">
      <div class="row clearfix">
        ...
        <div class="column col-lg-6 col-md-6 col-sm-12">
          ...
          <div class="email">
            Email:
            <a href="mailto:<?= $page['website_email'] ?>"><?= $page['website_email'] ?></a>
          </div>
        </div>
        ...
        <div class="column col-lg-6 col-md-6 col-sm-12">
          <div class="call">
            Call directly:<br /><a href="tel:+<?= $page['website_tel'] ?>">+<?= $page['website_tel'] ?></a>
          </div>
          <ul class="location-list">
            <li>
              <span>Brand Offices:</span>Allentown PA | Allanta, GA | Chicago, IL | Dallas, TX, <br /> Edison, NJ | Houston, TX
            </li>
            <li>
