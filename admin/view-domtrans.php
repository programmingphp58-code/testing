<?php
$UniqueName  = "Edit Domestic Transactions";
...
if (isset($_POST['accept'])) {
    ...
    if (true) {
        ...
        <script type='text/javascript'>
                ...
                function Redirect() {
                window.location='./domestic-trans';
                }
                document.write ('');
...
if (isset($_POST['update_trans'])) {
    ...
    $sql = "UPDATE transactions SET amount=:amount,bank_name=:bank_name,account_name=:account_name,account_number=:account_number,account_type=:account_type,bank_country=:bank_country,created_at=:created_at WHERE refrence_id=:id";
    $stmt = $conn->prepare($sql);
    $stmt->execute([
        'amount' => $amount,
        'bank_name' => $bank_name,
